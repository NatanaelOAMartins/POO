...
namespace _06_calendario
{
    internal class Calendario
    {
...

        {
            ...
            foreach (Feriado feriado in diasFeriados)
            {
                if (feriado != null)
                    Console.Write($"{feriado.Dia.ToString("D2")} - {feriado.Descricao}\t");
            }
        }
        public Feriado[] RetornaFeriados()
        {
            ...
            else if (mes == 9) feriados[indice++] = new Feriado (7,"Independencia do Brasil");
